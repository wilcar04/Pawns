      ...
      <tbody>
        {empenos.map(empeno => (
          <tr>
            ...
            <td className="py-4 bg-gray-100">{empeno.montoFinal}</td>
            <td className="py-4 bg-gray-100">{empeno.cantidad}</td>
            <td className="py-4 bg-gray-100">{empeno.precioRecuperar}</td>
            <td className="py-4 bg-gray-100">
              <button className='mr-5'>
                <img src='src/assets/accept.png' className='w-5' alt='Accept' />
              </button>
              <button className='mr-5'>
                <img src='src/assets/cancel.png' className='w-5' alt='Cancel' />
              </button>
              <button className='mr-5'>
...
function SaveChangesButton() {
  return (
    <div className='flex justify-end'>
      <button className='mt-10 mr-20 bg-rojo h-10 rounded w-40 text-white text-xs'>Guardar cambios</button>
    </div>
  );
}
...
function Layout() {
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="text-center text-blue-800 mt-5 mb-5 text-base sm:text-xs lg:text-xs font-bold">
