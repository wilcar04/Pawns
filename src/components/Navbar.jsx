...
export default function Navbar(){
    ...
    return(
        <nav className="flex items-center justify-start p-1 max-h-20 bg-white text-black border-b border-b-gray-300 shadow">
            ...
            <div className="grow flex justify-end ml-40 mr-10 items-center h-full gap-x-8 text-lg">
                ...
                <NavLink to="/about" className={({isActive}) => "py-1 text-sm basis-1/6 flex items-center justify-center max-h-max content-center my-2 mx-6 rounded-2xl " + (isActive? "font-bold cursor-default" : "hover:bg-gray-200")}>
                    ¿Quiénes somos?
                </NavLink>
            ...
            <div className="inline-flex items-center mx-5 gap-x-3">
                {
                    isLogged ?
                        <>
                            <Link to="/Car">
